...
- **Fontes:** PULO, OWN-PT, WordNet, ONTO-ILI  (colunas: ONTO, PULO, OWN-PT, WordNet)
- **Junção ILI (CILI):** ⚠ sem pares — junções OEWN↔PULO por ILI indisponíveis; só weak(term).
- **Gerado:** 2026-07-30T12:45:11
...
|---|---|---|---|---|---|---|---|---|---|
| composto | i114921 | — | UF | — | — | ili | fonte única | UF | atestado por ONTO-ILI enquanto admitido por PULO; ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| decomposição | i97733 | — | RT | — | — | single | fonte única | RT |  |
| descomposição | i97733 | — | RT | — | — | single | fonte única | RT |  |
| alquimia | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| composto químico | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| compostos químicos | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| empatia | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| química | i114921 | — | — | — | — | single | sinalização | — |  |
| substância | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| substância química | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
| substâncias químicas | i114921 | — | — | — | — | single | sinalização | — | ONTO-ILI: Onto→ILI accepted · onto:clip21:13381 → i114921 (score=0.3633) |
...
- **ONTO-ILI:** 0 antónimo(s) auto — antonímia consultável (OEWN)
...
| T9 | concordance.json faz round-trip (contagens de term/ili estáveis). | PASS ✅ | 11 conceitos |
