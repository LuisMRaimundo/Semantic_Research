...
- **Junções interfontes:** nenhuma — 16 item(ns) da matriz provenientes exclusivamente de PULO + OWN-PT (identificadores CILI normalizados na coluna ILI não implicam junção OEWN↔PULO).
...
|---|---|---|---|---|---|---|---|---|---|
| amalgamado | i6556 | — | RT | — | — | single | fonte única | RT |  |
| cabrito | i6556 | — | RT | — | — | single | fonte única | RT |  |
| combinação | i37400 | — | RT | — | — | single | fonte única | RT |  |
| composição | i37400, i52229, i62908 | — | RT | — | — | single | fonte única | RT |  |
| constituição | i62908 | — | RT | — | — | single | fonte única | RT |  |
| diverso | i6556 | — | RT | — | — | single | fonte única | RT |  |
| híbrido | i6556 | — | RT | — | — | single | fonte única | RT |  |
| mesclado | i6556 | — | RT | — | — | single | fonte única | RT |  |
| mestiço | i6556 | — | RT | — | — | single | fonte única | RT |  |
| misto | i6556 | — | RT | — | — | single | fonte única | RT |  |
| misturado | i6556 | — | RT | — | — | single | fonte única | RT |  |
| mulato | i6556 | — | RT | — | — | single | fonte única | RT |  |
...
- **ILIs ancorados (admitidos) sem material de contraste auto:** i37400, i52229, i62908, i6556
...
amalgamado, cabrito, combinação, composição, constituição, diverso, híbrido, mesclado, mestiço, misto, misturado, mulato
...
| T5 | Nenhum termo admitido pelos motores é descartado da matriz (PULO; OWN-PT/WordNet corroboram; Onto = descoberta) | PASS ✅ | 12 admitidos / 12 em matriz |
...
| T9 | concordance.json faz round-trip (contagens de term/ili estáveis). | PASS ✅ | 16 conceitos |
...
- `UF` · papel:papel35:HIPERONIMIA:HIPERONIMO_DE:composito · compósito, material
- `RT` · papel:papel35:PARTE:PARTE_DE_ALGO_COM_PROPRIEDADE:composito · compósito, utilidade
- `UF` · papel:papel35:PARTE:PROPRIEDADE_DE_ALGO_PARTE_DE:composito · compósito, substância
- `RT` · papel:papel35:REFERENTE:DIZ_SE_DO_QUE:composito · compósito, ter diverso utilidade
