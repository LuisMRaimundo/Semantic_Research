...
- **Tabela de equivalência ILI:** C:\Users\lmr20\Desktop\Semantic_Research\classes\TexturaUniforme\out\ili_equivalence.json  (3 mapeados, 5 revisão, 4 sem correspondência)
- **Gerado:** 2026-07-13T13:00:32
...
| invariável | — | UF | — | — | single | fonte única | UF | namespace não-mapeada (não-juntável): clip21:19004, contopt:28395, fuzzythes:23298, fuzzythes:27091, ontopt06:2945, polaridades:4484 |
...
| T2 | Junção weak(term) só ocorre sem ILI partilhado entre fontes (caso contrário aplicar-se-ia a junção por ILI). | PASS ✅ | 3 conceito(s) weak(term) |
