...
| constante | — | UF | — | — | single | fonte única | UF | namespace não-mapeada (não-juntável): contopt:28395, fuzzythes:23298, fuzzythes:27091 |
| imutável | — | UF | — | — | single | fonte única | UF | namespace não-mapeada (não-juntável): contopt:28395, fuzzythes:23298, fuzzythes:27091 |
| invariável | oewn-ili:i10771 | UF | — | sinalização | weak(term) | fonte única | UF | junção por termo — as fontes não partilham um ILI comum (fiabilidade menor); sinalizado por WordNet enquanto admitido por ONTO; namespace não-mapeada (não-juntável): contopt:28395, fuzzythes:23298, fuzzythes:27091, ontopt06:2945, polaridades:4484; WordNet: atestado na WordNet [pt_lemma (ILI)] · oewn-01973553-a · ILI i10771 |
| periódico | — | RT | — | — | single | fonte única | RT | namespace não-mapeada (não-juntável): contopt:28395 |
| regular | — | RT | — | — | single | fonte única | RT | namespace não-mapeada (não-juntável): contopt:28395 |
...
| farda | oewn-ili:i60712 | — | — | sinalização | single | sinalização | — | WordNet: atestado na WordNet [pt_lemma (ILI)] · oewn-04516887-n · ILI i60712 |
| fardamento | oewn-ili:i60712 | — | — | sinalização | single | sinalização | — | WordNet: atestado na WordNet [pt_lemma (ILI)] · oewn-04516887-n · ILI i60712 |
...
constante, imutável, invariável, periódico, regular
...
| T2 | Junção weak(term) só ocorre sem ILI partilhado entre fontes (caso contrário aplicar-se-ia a junção por ILI). | PASS ✅ | 2 conceito(s) weak(term) |
...
| T9 | concordance.json faz round-trip (contagens de term/ili estáveis). | PASS ✅ | 15 conceitos |
