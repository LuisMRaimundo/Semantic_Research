...
- Excluídos (off-axis): `['pwn30-00909545-a', 'ili-30-04745370-n', 'pwn30-02302187-a', 'pwn30-00910101-a', 'pwn30-04509592-n', 'pwn30-00744506-a', 'por-30-99999999-x']`

## Etapa 2 — Sementes (sinónimos de synsets admitidos)
Total: **5** — coerente, constante, imutável, invariável, uniforme
...
Admitidos: **4**  ·  Pendentes: **2**  ·  (atributo/oposicao/vizinha = evidência, fora de provenance)

| termo | estatuto | via | offset/ILI | teste decisivo | garantia | definição |
|-------|----------|-----|------------|----------------|----------|-----------|
| uniforme | UF | seed (Etapa 1/2) | pwn30-01200095-a, pwn30-01966488-a | derivado do sentido (PASSO 3) | sense_decision | — |
