# LexWarrant — concordância cruzada (**TexturaIntermitente**)

- **Política de divergência:** conservative
- **Fontes:** PULO, OWN-PT, WordNet, ONTO-ILI  (colunas: ONTO, PULO, OWN-PT, WordNet)
- **Junção ILI (CILI automático):** C:\Users\lmr20\Desktop\Semantic_Research\classes\TexturaIntermitente\out\ili_equivalence.cili.json  (1 pares CILI; 27 sem âncora partilhada)
- **Gerado:** 2026-07-27T21:34:24
...
|---|---|---|---|---|---|---|---|---|---|
| intermitente | ili-30-00593836-a, oewn-ili:i3299 | — | UF | — | — | ili | fonte única | UF | junção por ILI via tabela de equivalência: ili-30-00593836-a ↔ oewn-ili:i3299; atestado por ONTO-ILI enquanto admitido por PULO |
...
- **ILIs ancorados (admitidos) sem material de contraste auto:** ili-30-00593836-a
...
# Relatório residual — `TexturaIntermitente`
